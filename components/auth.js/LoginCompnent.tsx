    ...
    return (
        <div className='h-screen bg-gray-200 flex items-center justify-center w-full '>
            ...
            <div className='w-500 h-full'>
                <Image src="/image/this2.jpg" width={2000} height={2000} quality={100} alt="Messanger chat"
                ...
                <div className='w-[500px] mx-auto h-full bg-white px-10 py-10'>
                    <form action="">
                        ...
                        <div className='flex flex-col p-3'>
                            ...
                            <input className='w-full h-10 rounded border-2 outline-none px-2 text-sm' type="text" placeholder='Enter Username' />
                        </div>
                        <div className='flex flex-col p-3'>
                        ...
                        <div className='flex flex-col p-3'>
                            <button className='w-full h-10 bg-[#7269ef] text-white rounded hover:text-[#7269ef] hover:bg-white hover:border transition-all'>Sign in</button>
                        </div>
                    </form>
                </div>

                <div className='text-center py-5'>
                    <h2 className=' text-sm font-extrabold py-3'>{`Don't have an account`} <Link href="/register" className='text-[#7269ef]'>Sign up</Link></h2>
